                                ...
                                <div class="table-responsive">
                                    <display:table name="model.listResult" cellspacing="0" cellpadding="0" requestURI="${formUrl}"
                                        ...
                                        <display:column title="<fieldset class='form-group'>
                                            ...
                                            <c:if test="${presentUser != tableList.id}">
                                                <fieldset>
                                        ...
                                        <display:column headerClass="col-actions" title="Thao tác">
                                            <c:if test="${presentUser != tableList.id}">
                                                <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                   title="Cập nhật bài viết" href='<c:url value="/admin/user/edit?id=${tableList.id}"/>'><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            </c:if>
                                        </display:column>
